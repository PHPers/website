...
jvm.$ = $, Array.prototype.indexOf || (Array.prototype.indexOf = function (searchElement, fromIndex) {
    var k;
    ...
    switch (attr) {
        ...
        case"fill-opacity":
            ...
            break;
        case"stroke":
            "none" === value ? this.node.stroked = !1 : this.node.stroked = !0, this.node.strokecolor = value;
            break;
        case"stroke-opacity":
    ...
    mapNameByCode: function (code, multiMap) {
        ...
        return "$-jvectormap-data-" + code.toLowerCase() + "-" + multiMap.defaultProjection + "-en.js"
    }
};